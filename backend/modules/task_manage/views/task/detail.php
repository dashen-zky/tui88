...
AppAsset::addCss($this,"@web/src/css/task-manage/task-manage-detail.css?v=" . Yii::$app->params['static_version']);
?>
<!-- 面包屑 -->
<div class="bread">
    <ol class="breadcrumb font-500">
        <li><a href="<?= Url::to(['/site/index'])?>">首页</a></li>
        <li><a href="<?= Url::to(['/task-manage/task/list'])?>">任务列表</a></li>
        ...
        <div class="exe-info-wrap clearfix">
            <div class="exe-wrap-l fl">
                <div class="task-name info-group">
                    <span>任务名称：</span>
                    <span><?= $task_detail["title_detailed"]?></span>
                </div>
            ...
            <div class="exe-wrap-r fl">
                <div class="info-group clearfix">
                    ...
                    <div class="submit-con fl">
                        <?php if(isset($task_detail["executor_information_config"]["id_card"])):?>身份证<?php if(isset($task_detail["unique_config"]["id_card"])):?>（唯一）<?php endif;?><?php endif;?> &nbsp;
                        <?php if(isset($task_detail["executor_information_config"]["phone"])):?>手机号<?php if(isset($task_detail["unique_config"]["phone"])):?>（唯一）<?php endif;?><?php endif;?> &nbsp;
                        <?php if(isset($task_detail["executor_information_config"]["register_account"])):?>注册账号<?php if(isset($task_detail["unique_config"]["register_account"])):?>（唯一）<?php endif;?><?php endif;?> &nbsp;
                        <?php if(isset($task_detail["executor_information_config"]["screen_shots"])):?>截图<?php if(isset($task_detail["unique_config"]["screen_shots"])):?>（唯一）<?php endif;?><?php endif;?> &nbsp;
                    </div>
                </div>
                <div class="info-group">
