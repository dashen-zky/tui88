...
AppAsset::addCss($this,"@web/src/css/personal-center/execute-detail.css?v=" . Yii::$app->params['static_version']);
?>
<!-- 主要内容部分-->
    ...
    <div class="main-con-wrap">
        <div class="section-top section">
            ...
            <div class="tips-info">
                ...
                <?php if(!empty($detail["executor_information_config"]["screen_shots"])):?>
